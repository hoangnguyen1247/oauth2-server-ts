...
describe('TokenHandler integration', () => {
    ...
    describe('handleGrantType()', () => {
        ...
        it('should throw an error if `grantType` is unsupported', async () => {
            ...
            try {
                ...
                e.message.should.equal('Unsupported grant type: `grantType` is invalid');
            }
        });
        ...
        describe('with grantType `refreshToken`', () => {
            it('should return a token', () => {
                const client = { grants: ['refreshToken'] };
    ...
    describe('updateSuccessResponse()', () => {
        it('should set the `body`', () => {
            ...
            const tokenType = new token_types_1.BearerTokenType('foo', 'bar', 'biz', undefined, undefined, undefined);
            const response = new response_1.Response({ body: {}, headers: {} });
