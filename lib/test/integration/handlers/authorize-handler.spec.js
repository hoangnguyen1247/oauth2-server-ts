...
describe('AuthorizeHandler integration', () => {
    ...
    describe('getClient()', () => {
        ...
        it('should throw an error if `client.redirectUri` is invalid', async () => {
            ...
            try {
                ...
                e.should.be.an.instanceOf(errors_1.InvalidRequestError);
                e.message.should.equal('Invalid request: `redirectUri` is not a valid URI');
            }
        });
        ...
        it('should throw an error if `client.redirectUri` is not equal to `redirectUri`', () => {
            ...
            return handler
                ...
                .catch(e => {
                e.should.be.an.instanceOf(errors_1.InvalidClientError);
                e.message.should.equal('Invalid client: `redirectUri` does not match client value');
            });
        });
        it('should support promises', async () => {
            const model = {
    ...
    //   it('should throw an error if `responseType` is missing', () => {
    //     const model = {
    //       getAccessToken() {},
    //       getClient() {},
    //       saveAuthorizationCode() {},
    ...
    //       e.message.should.equal('Missing parameter: `responseType`');
    //     }
    //   });
    //   it('should throw an error if `responseType` is not `code`', () => {
    //     const model = {
    //       getAccessToken() {},
    //       getClient() {},
    //       saveAuthorizationCode() {},
    ...
    //     }
    //   });
    //   describe('with `responseType` in the request body', () => {
    ...
    //     });
    //   });
    //   describe('with `responseType` in the request query', () => {
    //     it('should return a response type', () => {
    //       const model = {
    //         getAccessToken() {},
    //         getClient() {},
